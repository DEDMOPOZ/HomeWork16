...
urlpatterns = [
    ...
    path('posts/', cache_page(20)(views.PostListView.as_view()), name='posts'),
    ...
    path('authors/all/', cache_page(20)(views.authors_all), name='authors_all'),
    ...
    path('categories/all/', cache_page(20)(views.categories_all), name='categories_all'),
